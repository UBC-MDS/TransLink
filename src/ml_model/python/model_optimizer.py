...
"""
This script prepares the train and test datasets to generate a predictive model. 
...
Usage: model_optimizer.py --train_file_path=<train_file_path> --bus_file_path=<bus_file_path> \
