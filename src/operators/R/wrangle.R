...
"This script reads in the raw data and then splits it into train/test sets. The files are
stored in the main data folder. This script assumes that the user is running this
...
main <- function(path_data, directory_out) {
  ...
  if (!dir.exists("data/operators")) {
    dir.create("data/operators")
  }
