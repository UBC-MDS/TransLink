...
best_bayes_model <- readRDS("all_analysis/operators/best-bayes-model.rds")
posterior_predictions <- readRDS("all_analysis/operators/posterior_samples.rds")
results <- readRDS("all_analysis/operators/validation-results.rds")
...
operators_dataset <- read_csv("all_analysis/operators/train.csv") %>%
  sample_n(5) %>%
...
class1 <- read_csv("all_analysis/ml_model/class1_shap.csv") %>%
  select(-X1) 

original_train <- read_csv("all_analysis/ml_model/full_data.csv") %>%
  select(-X1)
