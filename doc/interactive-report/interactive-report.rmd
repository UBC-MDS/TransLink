...
knitr::include_graphics("all_analysis/claim_costs/joining_datasets.png")
```
...
3. The percentage of the the number of incident in cost level 4 is almost double for the most experienced operators, which can be inferred as the experienced operators have involved in more severe incidents.
