...
3) An Analysis of Operators
4) Exploratory Data Analysis - Weather, Line, Location
5) Bringing Everything Together - Machine Learning Model to Assess Relative Risk For All Scenarios
6) Common Types of Claims by Location
7) Assessment of Claims Costs by Location
8) Recommendations and Future Analysis
...
TrankLink have proposed two specific hypotheses regarding a possible link between the operators experience level and how many incidents they are involved in within a year. Intuitvely, it makes a lot of sense that new drivers have a higher tendency to get into more accidents.
