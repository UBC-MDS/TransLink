...
```{r include=FALSE}
target_location_df = read_csv("/home/merve/Documents/TransLink/data/processed_data/collision_locations_with_coordinates.csv")
#     target_location_df <- target_location_df %>% drop_na(c("lat", "long"))
