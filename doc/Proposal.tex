...
required to carry \$1 million per occurrence liability policy on each of
its revenue vehicles and a \$200,000 per occurrence liability policy on
each of its non-revenue vehicles. Since 2014/2015, the premium paid to
ICBC has increased by over 200\% to cover onboard passenger injuries,
...
vehicles, the premium paid to its own captive insurance company has been
...
identifying the incidents/claims pattern, and root causes. The research
objectives are to:
...
\item
  ...
  geographic data, examine the main predicators of incidents and
